...
<link rel="stylesheet" href="<%=cp%>/imageTest/css/style.css"
	type="text/css" />
<link rel="stylesheet" href="<%=cp%>/imageTest/css/created.css"
	type="text/css" />

<script type="text/javascript" src="<%=cp%>/imageTest/js/util.js"></script>
...
function sendIt(){
	...
	f.action = "<%=cp%>/imageTest/signup.action";
	f.submit();
		...
		<form action="" method="post" name="myForm">
			...
			<div id="bbsCreated_footer">
				...
				<input type="reset" value="다시입력" class="btn2"
					onclick="document.myForm.userId.focus()" /> <input type="button"
					value="작성취소" class="btn2"
					onclick="javascript:location.href='<%=cp%>/imageTest/list.action';" />
